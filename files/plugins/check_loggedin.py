...
# A "CRITICAL' message is returned if a user is logged in from an unknown IP address or if logged in from terminal.
...
try:
    ...
    who_output = p1.communicate()[0].decode('utf-8')
